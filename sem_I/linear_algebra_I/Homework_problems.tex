...
$\\\noindent\rule{\linewidth}{0.5pt}\linebreak$
$\bf{6.9}$ Let $A_1,\ldots,A_n$ be the columns of $A$, $C_1,\ldots,C_m$ be the columns of $C$ and $B_1,\ldots,B_m$ be the columns of $B$  then in block form we can write, 
$$\begin{bmatrix}
...
$$A=\{a_{i,j}\}_{\substack{1\leq i\leq 1\\ 1\leq j\leq 1}},B=\{a_{i,j}\}_{\substack{1\leq i\leq 1\\ 1<j\leq n}},C=\{a_{i,j}\}_{\substack{1<i\leq n\\ 1<j\leq n}}$$
