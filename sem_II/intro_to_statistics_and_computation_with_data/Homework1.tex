...
\end{knitrout}
  \item 
  That command outputs the sum of all those entries in the vector \texttt{scoreSS} which are greater than or equal to $9$. 
  
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlnum{100}\hlopt{*}\hlkwd{length}\hldef{(scoreSS[scoreSS}\hlopt{<}\hlnum{17}\hldef{])}\hlopt{/}\hlkwd{length}\hldef{(scoreSS)}
\end{alltt}
\begin{verbatim}
## [1] 100
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hldef{Shreelakshmibill} \hlkwb{=} \hlkwd{c}\hldef{(}\hlnum{460}\hldef{,}\hlnum{330}\hldef{,}\hlnum{390}\hldef{,}\hlnum{370}\hldef{,}\hlnum{460}\hldef{,}\hlnum{300}\hldef{,}\hlnum{480}\hldef{,}\hlnum{320}\hldef{,}\hlnum{490}\hldef{,}\hlnum{350}\hldef{,}\hlnum{300}\hldef{,}\hlnum{280}\hldef{)}
\hldef{Shreelakshmibill}
\end{alltt}
\begin{verbatim}
##  [1] 460 330 390 370 460 300 480 320 490 350 300 280
\end{verbatim}
\begin{alltt}
...
\end{knitrout}
  ...
  \item 
  The number of months with the amount being greater than $50$ can be found as follows:
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
##  [1] 2540 2670 2610 2630 2540 2700 2520 2680 2510 2650 2700 2720
\end{verbatim}
\end{kframe}
\end{knitrout}
